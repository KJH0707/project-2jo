...
<body>
<h5  style="font-weight: bold; text-align: center">약관 동의</h5>
<hr>
<h6 style="text-align: center">이용약관 동의<span style="color: red">(필수)</span></h6><br>

<textarea rows="20" cols="50" style="margin-left:40px;">
제1조(목적) 이 약관은 업체 회사(전자상거래 사업자)가 운영하는 업체  "포크 앤 나이프" (이하 “몰”이라 한다)에서 제공하는 인터넷 관련 서비스(이하 “서비스”라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리․의무 및 책임사항을 규정함을 목적으로 합니다.
