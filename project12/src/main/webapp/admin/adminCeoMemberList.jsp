                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-9 col-lg-12 col-md-6 col-sm-12 col-12">
                                ...
                                <ul class="nav nav-pills mb-3 nav-justified" id="pills-tab" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link" href="./adminGenMemList.us">일반 회원</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link active" href="./adminCeoMemList.us">점주 회원</a>
                                    </li>
                                </ul>
				                                            ...
				                                            <ul class="pagination">
				                                            	<c:if test="${reqeustScope.totalCnt != 0 }">
				                                            		<c:if test="${startPage > pageBlock }">
						                                                <li class="page-item"><a class="page-link" href="./adminCeoMemList.us?pageNum=${startPage-pageBlock }">Previous</a></li>
						                                            </c:if>
						                                            <c:forEach var="i" begin="${startPage }" end="${endPage }" step="1">
						                                                <li class="page-item"><a class="page-link"  href="./adminCeoMemList.us?pageNum=${i }">${i }</a></li>
						                                            </c:forEach>   
						                                            <c:if test="${endPage < pageCount }">
						                                                <li class="page-item"><a class="page-link"  href="./adminCeoMemList.us?pageNum=${startPage+pageBlock }">[Next]]</a></li>
						                                            </c:if>
