...
<!-- 			  </div> -->
		 <div class="form-content bk">
				<form action="./JoinAction.us" method="POST"  align="left" name="fr" onsubmit="return false" >
					<p><h2  style="text-align:center; color:black">추 가 입 력</h2></p>
				<!-- /////////////// 필수입력 사항 ////////////////////////-->
					<fieldset class="scheduler-border" >
						...
						<div class="row">
							...
							<div class="col-SM-2" style="padding:0 0 0 15px">
							  ...
							  <input type="text" class="form-control" id="name" value="${param.kakao_nickname }" name="name"  style="width:300px" maxlength="20" readonly="readonly">
							</div>
							...
							<div class="col-SM-2" style="padding:0 0 0 15px">
							  ...
							  <input type="email" class="form-control" id="email" value="${param.kakao_id }" name="email"  style="width:300px" readonly="readonly">
							  <input type="hidden" >
							</div>
					...
					<fieldset class="scheduler-border" id="choose">
						...
						<div class="row">
							<div class="col-SM-2" style="padding:0 0 0 15px">
							  ...
							  <input type="date" class="form-control" id="date" name="birth"  style="width:200px">
							</div>
